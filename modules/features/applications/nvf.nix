# NVF — Neovim configured via nvf framework
# Source: home/modules/applications/nvf.nix
...
{ self, inputs, ... }: {
  ...
  flake.homeModules.nvf = { config, pkgs, lib, pkgs-unstable, pkgs24-11, ... }: let
        ...
        settings = {
          vim = {
            ...
            extraPlugins = {
              ...
              vscode-diff-nvim = {
                package = pkgs-unstable.vimPlugins.codediff-nvim;
              };
