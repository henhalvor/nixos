      ...
      config = {
        ...
        services.syncthing = {
          ...
          settings = {
            devices = {
              "workstation" = {
                id = "VDQBMZD-3LCRWHG-7IZ7HLT-G3JQU25-SDUKIWP-BG4RMSA-VBZ6FNC-XPR5PQG";
              };
              "yoga-pro-7" = {
                id = "T2SDKBB-6W6PC6S-2MOF26Y-ISGI7GM-NV3G7U3-XQKVF7N-WD76D4R-IEIURQQ";
              };
              "android-phone" = {
                id = "GCRWWEH-SVM56QX-Z6BIO6J-LBVY2Z5-2KETSSL-ULFPLSQ-J25KU6W-GJIQTAO";
              };
              "android-tablet" = {
                id = "OMVTIWA-LM256KO-JDZPTK3-BTALD4W-LG6JTND-7VZQO7X-3KU5HEQ-LP6ELQX";
              };
              "hp-server" = {
                id = "32LVQHB-KVKBTRF-ZLOZATD-NAHXNFI-3SINNKH-DR4LGOB-HTGYK3O-UA3VPAZ";
              };
            };
