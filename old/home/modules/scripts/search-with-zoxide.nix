  ...
  search-with-zoxide = pkgs.writeShellScriptBin "search-with-zoxide" ''
    ...
    search_with_zoxdie() {
        if [ -z "$1" ]; then
            ...
            lines=$(zoxide query -l | xargs -I {} fd --type f -I -H -E .git -E .git-crypt -E .cache -E .backup -E .vscode -E node_modules -E dist -E build -E target -E .direnv -E coverage -E .next -E .turbo -E out -E tmp -E vendor "$1" {} | fzf --no-sort) # Initial filter attempt with fzf
