...

{
  ...
  xdg.configFile."hypr/hyprpaper.conf".text = ''
    preload = ~/.dotfiles/home/modules/window-manager/hyprpaper/catpuccin_landscape.png


    wallpaper = ,~/.dotfiles/home/modules/window-manager/hyprpaper/catpuccin_landscape.png
