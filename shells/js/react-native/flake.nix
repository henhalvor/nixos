{
  description =
    "Creates an environment in which you can create, build and emulate an expo app, and a script which creates, builds and emulates an expo app.";

  inputs = {
    nixpkgs.url =
      "github:nixos/nixpkgs?rev=55d15ad12a74eb7d4646254e13638ad0c4128776";
    #nixpkgs.url = "github:nixos/nixpkgs?ref=nixos-unstable&rev=55d15ad12a74eb7d4646254e13638ad0c4128776";

    android.url =
      "github:tadfisher/android-nixpkgs?rev=a21442ddcdf359be82220a6e82eff7432d9a4190";
  ...
  outputs = { self, nixpkgs, ... }@inputs:
    ...
    in {
      packages.x86_64-linux.android-sdk = inputs.android.sdk.x86_64-linux
        (sdkPkgs: [
      ...
      # yarn
      #
      # # Android development base tools (NDK will be installed by shellHook)
      # androidSdk.androidsdk # The composed SDK base
      # jdk17 # Required Java version
      #
      # # Build essentials
      # gradle
      # pkg-config
      # rsync # For the shellHook copy step
      #
      # # Development tools
      # watchman
      #
      # # System dependencies needed by SDK tools
      # zlib
      # ncurses5
      # stdenv.cc.cc.lib
      #
